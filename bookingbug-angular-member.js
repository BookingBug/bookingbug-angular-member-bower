        ...
        scope.$watch('wallet', function(wallet) {
          ...
          if (wallet && !scope.amount) {
            if (scope.wallet_payment_options.basket_topup && scope.bb.basket.dueTotal() > wallet.amount) {
              ...
              scope.amount = scope.wallet_payment_options.amount && scope.wallet_payment_options.amount > wallet.min_amount ? scope.wallet_payment_options.amount : walllet.min_amount;
